	...
	<div class="home">
		<div class="col-md-12 mb-3">
			<div class="card card-default">
				<div class="card-header bg-primary text-white"><strong>Test psychotechnique...</strong></div>
				<div class="card-body">
					<h4 class="card-title">Test d'obtention de bourse</h4>
					<p>Cet test nous permet de Lorem ipsum dolor sit amet consectetur adipisicing elit. E!</p>
				</div>
			</div>
		</div>
		<div v-if="isLoading">
		...
		<div v-else>
			...
			<div class="row">
			    <div class="col-md-4 mt-2"  v-for="q in quizzes" :key="q.id">
			    	<div class="card card-default quiz-card">
			    		<div class="card-header">{{q.title}} <span class="badge badge-info pull-right tip">{{q.questCount}} <span class="tooltiptext">Question count</span></span> </div>
			    		    <div class="card-body">
								<h4 class="card-title">Débuter le test...</h4>
			    		        <button class="btn btn-outline-info btn-block" @click="PlayQuiz(q.id)"><i class="fa fa-play"></i> Commencer</button>
			    		    </div>
...
<style scoped>
	...
	.quiz-card:hover{
		box-shadow: 2px 3px 2px 3px #911595;
