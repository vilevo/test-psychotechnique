			    		...
			    		<div class="card-header bg-primary text-white">
			    		    ...
			    		    <div class="card-body">
								...
								<template v-if="currentQuestionNo+1 >totalQuestions">
									<button type="button" class="btn btn-outline-info btn-block" @click="loadNextQuestion"> Terminer <i class="fa fa-forward"></i></button>
								</template>
								<template v-else>
									<button type="button" v-bind:class="{disabled:option == null}" class="btn btn-outline-info btn-block " @click="loadNextQuestion"> Suivant <i class="fa fa-forward"></i></button>
								</template>
